  ...
  <div id="content">
    ...
    <div class="parte_Esquerda">
      ...
      <p id="descricao">
        ...
        illum similique voluptas porro vel labore totam id placeat quidem a
        earum. Lorem ipsum dolor sit amet consectetur adipisicing elit.
        Doloribus facilis adipisci pariatur deserunt nulla illo itaque! Ipsum
        veritatis aspernatur ad delectus iusto assumenda et ea dignissimos
        obcaecati quod, id repudiandae. Lorem ipsum dolor sit amet consectetur
        adipisicing elit. Commodi, reiciendis eius aliquid numquam ab ea, velit
        pariatur.
      </p>
    </div>
  </div>
...
export default {
  ...
  data() {
    return {
      ...
      // Contador que recebe o número ZERO
      cont: 0,
      // Bolas do carrosel que quando a página carrega, aparece a primeira bolinha (questão de visibilidade)
      Bcarro1: true,
      Bcarro2: false,
      Bcarro3: false,
      Bcarro4: false,
  ...
  methods: {
    // Função que troca a imagem ao ser clicada
    TrocaDeImgs() {
      if (this.cont == 0) {
    ...
    // Ao clicar na seta da esquerda, ele irá trocar a imagem
    TrocarEsquerda() {
      if (this.cont == 0) {
        this.cont = 4;
      } else {
    ...
    // Ao clicar na seta da direita, ele irá trocar a imagem
    TrocarDireita() {
      if (this.cont == 4) {
        this.cont = 0;
      } else {
