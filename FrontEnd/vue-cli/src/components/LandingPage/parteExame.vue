<template>
  <div id="HExames">
    ...
    <!-- Parte amarela onde estão os exames -->
    <div class="exames" id="HomeExames">
      <!-- Título -->
      <h1 class="titulo_exame">Exames</h1>
      <!-- Onde os círculos estão posicionados -->
      <div class="listas_row">
        <div class="lista cima">
          <!-- Nome da imagem que está sendo utilizada como "imagem2" -->
        ...
        <div class="lista cima">
          <!-- Nome da imagem que está sendo utilizada como "imagem1" -->
        ...
        <div class="lista cima">
          <!-- Nome da imagem que está sendo utilizada como "imagem3" -->
...
export default {
  ...
  data() {
    return {
      // Nome das imagens que estão sendo usadas no código
